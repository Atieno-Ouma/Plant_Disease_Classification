...
class GoogLeNet:
    ...
    def inception_module(x, num1x1, num3x3Reduce, num3x3, num5x5Reduce, num5x5, 
        ...
        #define the second branch of the Inception module which consists of 1x1 and 
        #3x3 convolutions
        ...
        #define the third branch of the Inception module which are both 1x1 and 
        #5x5 convolutions
    ...
    def build(width, height, depth, classes, reg = 0.0005):
        ...
        x = GoogLeNet.conv_module(inputs, 64, 5, 5, (1, 1), chanDim, reg = reg, 
        	name = "block1")
        x = MaxPooling2D((3, 3), strides = (2, 2), padding = "same", name = "pool1")(x)
        x = GoogLeNet.conv_module(x, 64, 1, 1, (1, 1), chanDim, reg = reg, 
            name = "block2")
